...
var VSalesTask = /** @class */ (function (_super) {
    ...
    function VSalesTask() {
        ...
        _this.page = observer(function (task) {
            var _a = _this.controller, showSalesTaskComplet = _a.showSalesTaskComplet, showSalesTaskExtension = _a.showSalesTaskExtension, onInvalidTask = _a.onInvalidTask, showCustomerDetail = _a.showCustomerDetail, showSalesTaskHistory = _a.showSalesTaskHistory;
    ...
    VSalesTask.prototype.open = function (task) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.controller.lodeSalesTaskDetail(task.id)];
                    case 1:
                        model = _a.sent();
