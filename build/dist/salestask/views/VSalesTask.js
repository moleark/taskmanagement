...
import { LMR, EasyDate, PropGrid } from 'tonva';
import { observer } from 'mobx-react';
import { tv } from 'tonva';
var VSalesTask = /** @class */ (function (_super) {
    tslib_1.__extends(VSalesTask, _super);
    function VSalesTask() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.page = observer(function (task) {
            var _a = _this.controller, showSalesTaskComplet = _a.showTaskComplet, showSalesTaskExtension = _a.showTaskExtension, showSalesTaskInvalid = _a.showTaskInvalid, showCustomerDetail = _a.showCustomerDetail, showSalesTaskHistory = _a.showTaskHistory;
            ...
            var onInvalid = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, showSalesTaskInvalid(task)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            }); }); };
            ...
            var rightButton = React.createElement("span", null,
                ...
                React.createElement("button", { type: "button", className: "btn btn-outline-info ml-3", onClick: onInvalid }, "\u62D2\u7EDD"));
    ...
    VSalesTask.prototype.open = function (task) {
...
export { VSalesTask };
//# sourceMappingURL=VSalesTask.js.map